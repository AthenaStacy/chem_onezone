...
void spline_coefficients(int nval, double *values, double (*coefficients)[NDATA-1]);
...
*/
        ...
        if (I == 0) {
            Cc[I][I]      = 2.e0;
            Cc[I][I+1]    = 1.e0;
            Cc[I][nval]   = 3.e0 * (values[2-1] - values[1-1]);
        }
        else if (I == nval-1) {
            Cc[I][I-1]    = 1.e0;
            Cc[I][I]      = 2.e0;
            Cc[I][nval]   = 3.e0 * (values[nval-1] - values[nval-1-1]);
        }
        else {
            Cc[I][I-1]    = 1.e0;
            Cc[I][I]      = 4.e0;
            Cc[I][I+1]    = 1.e0;
            Cc[I][nval]   = 3.e0 * (values[I+1] - values[I-1]);
        }
    }
